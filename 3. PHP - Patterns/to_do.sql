...
CREATE TABLE `tasques` (
  ...
  `inici_tasques` datetime NOT NULL,
  `fi_tasques` datetime DEFAULT NULL,
...
INSERT INTO `tasques` VALUES (3,'Llamar Seguro','Negociar Precio Renovación','Pendent','2023-07-03 00:00:00','0000-00-00 00:00:00',4),(4,'Regalo Cumple','Buscar Regalo Aniversario','Pendent','2023-06-27 00:00:00','0000-00-00 00:00:00',4),(7,'Pagar IVTM','Pago Online Impuesto','Pendent','2023-06-26 00:00:00','0000-00-00 00:00:00',4),(8,'Veterinario','Llamar Veterinario Tokyo','Pendent','2023-06-30 00:00:00','0000-00-00 00:00:00',5),(9,'GarraPulgas','Llamar Veterinario','Pendent','2023-06-28 00:00:00','0000-00-00 00:00:00',5),(12,'Peluqueria','Llamar para pedir hora','En Execució','2023-06-28 00:00:00','2023-07-04 00:00:00',5),(15,'Examen Opos','Estudiar Oposiciones','En Execució','2023-06-29 00:00:00','2023-07-01 00:00:00',4);
...
-- Dump completed on 2023-07-11 11:56:31
